...
class SuperBlock(object):
    def __init__(self, file_input):
        reader = binaryreader.BinaryReader(file_input[1024:])
        ...
        self.s_block_size = 1024 << reader.getDataFromBinary(24, 28, "<I")
        ...
        self.s_feature_compat = reader.getDataFromBinary(92, 96, "<I")
        self.s_feature_incompat = reader.getDataFromBinary(96, 100, "<I")
        self.s_feature_ro_compat = reader.getDataFromBinary(100, 104, "<I")
